...
public class EditData extends javax.swing.JFrame {
    ...
    App mainApp = new App();
JTable table = mainApp.getJTable1();
    ...
    public JTextField getKodeBarangTextField() {
    return KodeBarangTextField;
}
...
public JTextField getJumlahBarangTextField() {
    return JumlahBarangTextField;
}



    public EditData(App mainApp) {
    initComponents();
    this.mainApp = mainApp;
    this.table = mainApp.getJTable1();
}
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(JumlahBarangTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(KodeBarangTextField)
                            .addComponent(NamaBarangTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(148, 148, 148)
    ...
    String kode = KodeBarangTextField.getText().trim();
    String nama = NamaBarangTextField.getText().trim();
    String jumlah = JumlahBarangTextField.getText().trim();
    ...
    // Validasi jumlah barang adalah angka
    try {
    ...
    // Akses tabel melalui instance mainApp
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                App app = new App();
                new EditData(app).setVisible(true);
            }
        });
    }
